...
JNIEXPORT jlong JNICALL Java_eves_de_pulse_Pulse__1initialize
  (JNIEnv *jenv, jclass)
  {
    LOGD("Java_eves_de_pulse_Pulse__1initialize enter");
    jlong result = 0;
    try
    {
    ...
    LOGD("Java_eves_de_pulse_Pulse__1initialize exit");
    return result;
  }
...
JNIEXPORT void JNICALL Java_eves_de_pulse_Pulse__1load
  ...
  {
    LOGD("Java_eves_de_pulse_Pulse__1load enter");
    ...
    LOGD("Java_eves_de_pulse_Pulse__1load exit");
  }
...
JNIEXPORT void JNICALL Java_eves_de_pulse_Pulse__1start
  ...
  {
    LOGD("Java_eves_de_pulse_Pulse__1start enter");
    try
    {
        if (self)
    ...
    LOGD("Java_eves_de_pulse_Pulse__1start exit");
  }
...
JNIEXPORT void JNICALL Java_eves_de_pulse_Pulse__1onFrame
  ...
  {
    LOGD("Java_eves_de_pulse_Pulse__1onFrame enter");
    try
    {
        if (self) {
    ...
    LOGD("Java_eves_de_pulse_Pulse__1onFrame exit");
  }
...
JNIEXPORT jint JNICALL Java_eves_de_pulse_Pulse__1facesCount
  ...
  {
    LOGD("Java_eves_de_pulse_Pulse__1facesCount enter");
    try
    {
        if (self)
    ...
    LOGD("Java_eves_de_pulse_Pulse__1facesCount exit");
    return 0;
  }
...
JNIEXPORT jlong JNICALL Java_eves_de_pulse_Pulse__1face
  ...
  {
    LOGD("Java_eves_de_pulse_Pulse__1face enter");
    try
    {
        if (self)
    ...
    LOGD("Java_eves_de_pulse_Pulse__1face exit");
    return 0;
  }
...
JNIEXPORT jdouble JNICALL Java_eves_de_pulse_Pulse__1relativeMinFaceSize
  (JNIEnv *jenv, jclass, jlong self)
{
    LOGD("Java_eves_de_pulse_Pulse__1maxSignalSize enter");
    jdouble result = 0;
    try
    {
        if (self)
    ...
    LOGD("Java_eves_de_pulse_Pulse__1maxSignalSize exit");
    return result;
  }
...
JNIEXPORT jboolean JNICALL Java_eves_de_pulse_Pulse__1faceDetection__J
  (JNIEnv *jenv, jclass, jlong self)
  {
    LOGD("Java_eves_de_pulse_Pulse__1faceDetection__J enter");
    jboolean result = false;
    try
    {
        if (self)
            result = ((Pulse*)self)->faceDetection.enabled;
    }
    catch(cv::Exception& e)
    {
        jclass je = jenv->FindClass("org/opencv/core/CvException");
    ...
    LOGD("Java_eves_de_pulse_Pulse__1faceDetection__J exit");
    return result;
  }
...
JNIEXPORT void JNICALL Java_eves_de_pulse_Pulse__1faceDetection__JZ
  ...
  {
    LOGD("Java_eves_de_pulse_Pulse__1faceDetection__JZ enter");
    try
    {
        if (self)
            ((Pulse*)self)->faceDetection.enabled = m;
    }
    catch(cv::Exception& e)
    {
        jclass je = jenv->FindClass("org/opencv/core/CvException");
    ...
    LOGD("Java_eves_de_pulse_Pulse__1faceDetection__JZ exit");
  }
...
JNIEXPORT jboolean JNICALL Java_eves_de_pulse_Pulse__1magnification__J
  (JNIEnv *jenv, jclass, jlong self)
  {
    LOGD("Java_eves_de_pulse_Pulse__1magnification__J enter");
    jboolean result = false;
    try
    {
        if (self)
    ...
    LOGD("Java_eves_de_pulse_Pulse__1magnification__J exit");
    return result;
  }
...
JNIEXPORT void JNICALL Java_eves_de_pulse_Pulse__1magnification__JZ
  (JNIEnv *jenv, jclass, jlong self, jboolean m)
  {
    LOGD("Java_eves_de_pulse_Pulse__1magnification__JZ enter");
    try
    {
        if (self)
    ...
    LOGD("Java_eves_de_pulse_Pulse__1magnification__JZ exit");
  }
...
JNIEXPORT void JNICALL Java_eves_de_pulse_Pulse__1destroy
  (JNIEnv *jenv, jclass, jlong self)
  {
    LOGD("Java_eves_de_pulse_Pulse__1destroy enter");
    try
    {
        if (self)
            delete (Pulse*)self;
    ...
    LOGD("Java_eves_de_pulse_Pulse__1destroy exit");
  }
